    ...
    <form onSubmit={handleSubmit} className={styles.formulario}>
          ...
          return (
            <div key={campo.name} className={styles.grupo}>
              <label className={styles.label}>
                {campo.label}
                {campo.required && <span className={styles.obligatorio}>*</span>}
              </label>
              ...
              {campo.type === 'text' || campo.type === 'email' ? (
                ...
                <input
                  ...
                  onChange={(e) => onCambio(campo.name, parseInt(e.target.value))}
                  disabled={!esEditando || campo.disabled}
                  className={styles.input}
                  required={campo.required && esEditando}
                />
      ...
      <div className={styles.acciones}>
        ...
        {esEditando && (
          ...
          >
            {cargando ? 'Guardando...' : modo === 'crear' ? 'Crear' : 'Actualizar'}
          </button>
        )}
      </div>
    </form>
