          ...
          secciones: [
            {
              ...
              items: [
                { label: 'Dashboard', ruta: '/admin/dashboard', icono: FiBarChart2 },
          ...
          secciones: [
            {
              titulo: 'OPERACIONES',
              items: [
                { label: 'Dashboard', ruta: '/supervisor/dashboard', icono: FiBarChart2 },
                {
                  label: 'Mis Tareas',
          ...
          secciones: [
            {
              ...
              items: [
                { label: 'Dashboard', ruta: '/user/dashboard', icono: FiBarChart2 },
                {
                  label: 'Mis Tareas',
                  ruta: '/user/tareas',
                  icono: FiCheckSquare,
