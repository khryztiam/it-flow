...
// Helper para normalizar nombres de países (remover acentos)
          ...
          <div className={styles.seccion}>
            ...
            <div className={styles.seccionContenido}>
              {plantas.length === 0 ? (
                ...
                plantas.map((planta) => {
                  const bandera =
                    MAPEO_BANDERAS[planta.pais?.nombre?.toLowerCase()] || '🌐';
                  return (
                    <div
                      key={planta.id}
                    ...
                    >
                      <div className={styles.itemCardsTexto}>
                        <span className={styles.itemBandera}>{bandera}</span>
          ...
          <div className={styles.seccion}>
            ...
            <div className={styles.seccionContenido}>
              {paises.length === 0 ? (
                ...
                paises.map((pais) => {
                  const bandera =
                    MAPEO_BANDERAS[pais.nombre.toLowerCase()] || '🌐';
                  return (
                    <div
                      key={pais.id}
                      className={styles.itemSidebar}
