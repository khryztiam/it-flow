      ...
      <div className={styles.contenido}>
        ...
        <div className={styles.main}>
          <div className={styles.encabezado}>
            <h3>👥 Usuarios</h3>
            <button onClick={() => handleNuevo('usuarios')} className={styles.btnNuevo}>
              + Agregar Usuario
            </button>
          </div>
        ...
        <div className={styles.sidebar}>
          ...
          <div className={styles.seccion}>
            <h4 className={styles.seccionTitulo}>🏭 Plantas ({plantas.length})</h4>
            <div className={styles.seccionContenido}>
              {plantas.length === 0 ? (
                <p style={{ color: '#999', fontSize: '12px' }}>No hay plantas</p>
              ) : (
                plantas.map((planta) => (
                  <div key={planta.id} className={styles.itemSidebar}>
          ...
          {/* Países */}
          <div className={styles.seccion}>
            <h4 className={styles.seccionTitulo}>🌍 Países ({paises.length})</h4>
            <div className={styles.seccionContenido}>
              {paises.length === 0 ? (
