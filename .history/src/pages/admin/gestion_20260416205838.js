...
export default function GestionAdmin() {
  ...
  const cargarDatos = async () => {
    try {
      ...
      // Cargar datos desde APIs + obtener roles desde supabase
      const [paisesRes, plantasRes, usuariosRes, rolesRes] = await Promise.all([
        ...
        <div className={styles.main}>
          ...
          <TablaGenerica
            ...
            acciones={[
              ...
              {
                label: '🗑️',
                onClick: (registro) => handleEliminar(registro, 'usuarios'),
                color: 'danger',
              },
            ]}
            cargando={cargando}
              ...
              : tipoFormulario === 'plantas'
                ...
                : [
                    ...
                    },
                    {
                      ...
                      disabled: modoFormulario === 'editar',
                      ayuda: 'Se usará para: usuario@itflowapp.com',
                      mostrarEn: ['crear'],
                    },
                    {
                      name: 'password',
                      ...
                      type: 'password',
                      required: modoFormulario === 'crear',
                      placeholder: modoFormulario === 'crear' ? 'Ej: MinaT@123' : '(Dejar vacío para no cambiar)',
                      ayuda: modoFormulario === 'crear' ? 'Contraseña inicial' : 'Dejar vacío para mantener la actual',
                    },
                    {
                      name: 'rol_id',
                      label: 'Rol',
