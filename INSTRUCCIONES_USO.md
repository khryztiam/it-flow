...
3. **Cambiar estado:** Dropdown para actualizar fase (Pendiente / En proceso / Completado / En revisión)
4. **Revisar tarea:** Campo "REVISADO POR" — Aceptar o rechazar la tarea completada
   - ❌ Pendiente de revisión → Acepto la tarea (marca como revisada)
   - ✅ Revisado — La tarea fue aceptada
5. **Agregar observaciones:** Notas administrativas
6. **Ver evidencias:** Archivos cargados por el usuario
